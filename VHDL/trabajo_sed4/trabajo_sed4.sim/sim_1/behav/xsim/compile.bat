...
REM
REM Generated by Vivado on Wed Dec 17 13:28:52 +0100 2025
...
echo "xvhdl --incr --relax -prj TOP_ASCENSOR_TB_vhdl.prj"
call xvhdl  --incr --relax -prj TOP_ASCENSOR_TB_vhdl.prj -log xvhdl.log
