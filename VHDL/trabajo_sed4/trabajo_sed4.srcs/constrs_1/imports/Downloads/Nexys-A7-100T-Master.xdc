## This file is a general .xdc for the NexysA7 100T Rev. C
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { BTNC }]; #IO_L4N_T0_D05_14 Sch=btnu Piso 0
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { BTNL }]; #IO_L12P_T1_MRCC_14 Sch=btnl Piso 3
