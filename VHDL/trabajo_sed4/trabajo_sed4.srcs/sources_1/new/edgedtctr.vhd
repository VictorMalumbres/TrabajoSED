...
begin
    ...
    begin
        if rising_edge(clk) then
            inputs_sync <= switches & botones; -- Concatenamos
            inputs_prev <= inputs_sync;
            
            nueva_peticion <= '0';
            piso_llamada <= 0; 

            -- LOGICA MODIFICADA: Detectar DESIGUALDAD (/=) en vez de flanco subida.
            -- Esto permite que el switch active la llamada al moverlo arriba O abajo.
            
            -- Prioridad al piso más alto
            -- Switch 3 o Botón 3
