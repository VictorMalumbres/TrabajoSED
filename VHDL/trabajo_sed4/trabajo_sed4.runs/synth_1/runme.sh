...
HD_PWD='C:/Users/victo/Documents/GitHub/TrabajoSED/VHDL/trabajo_sed4/trabajo_sed4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_ASCENSOR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_ASCENSOR.tcl
